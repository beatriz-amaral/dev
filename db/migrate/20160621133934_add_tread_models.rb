class AddTreadModels < ActiveRecord::Migration
  def up
    execute <<-SQL
      INSERT INTO savetyre_tread_models (name,tread_brand_id,tread_type_id,number_of_grooves,customer_id,created_at,updated_at) VALUES ('UNDEFINED',1,1,null,3,now(),now());
      INSERT INTO savetyre_tread_models (name,tread_brand_id,tread_type_id,number_of_grooves,customer_id,created_at,updated_at) VALUES ('UNDEFINED',2,1,null,3,now(),now());
      INSERT INTO savetyre_tread_models (name,tread_brand_id,tread_type_id,number_of_grooves,customer_id,created_at,updated_at) VALUES ('UNDEFINED',3,1,null,3,now(),now());
      ...
      INSERT INTO savetyre_tread_models (name,tread_brand_id,tread_type_id,number_of_grooves,customer_id,created_at,updated_at) VALUES ('UNDEFINED',1,1,null,4,now(),now());
      INSERT INTO savetyre_tread_models (name,tread_brand_id,tread_type_id,number_of_grooves,customer_id,created_at,updated_at) VALUES ('UNDEFINED',2,1,null,4,now(),now());
      INSERT INTO savetyre_tread_models (name,tread_brand_id,tread_type_id,number_of_grooves,customer_id,created_at,updated_at) VALUES ('UNDEFINED',3,1,null,4,now(),now());
  ...
  def down
    execute <<-SQL
      DELETE FROM savetyre_tread_models WHERE name 'UNDEFINED' and customer_id = 3 and tread_brand_id = 1;
      DELETE FROM savetyre_tread_models WHERE name 'UNDEFINED' and customer_id = 3 and tread_brand_id = 2;
      DELETE FROM savetyre_tread_models WHERE name 'UNDEFINED' and customer_id = 3 and tread_brand_id = 3;
      ...
      DELETE FROM savetyre_tread_models WHERE name 'UNDEFINED' and customer_id = 4 and tread_brand_id = 1;
      DELETE FROM savetyre_tread_models WHERE name 'UNDEFINED' and customer_id = 4 and tread_brand_id = 2;
      DELETE FROM savetyre_tread_models WHERE name 'UNDEFINED' and customer_id = 4 and tread_brand_id = 3;
