class AdicionarVerificacaoInd < ActiveRecord::Migration
  def up
    execute <<-SQL
      ...
      VALUES
      (now(), 3, 'marcaolegal',  null,  null,  null, 1,  null,  3, null,  14, 515,  null,  110.0,  120.0,  null, 0,  null,  null,  null,  17,  0,  2,  12, 1,  2,now(), null, null);
    SQL
  end
